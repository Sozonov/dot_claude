...
2.  **Определи папку для файлов плана:**
    - найди папку задачи `cat ~/.claude/docs/taskDir.md` и там изучи файоы `task.md`,  `task_docs.md` и `plan_draft.md`
...
7.  (ВАЖНО!) Придерживайся следующих принципов при создании плана работы:
    - Не дроби план на слишком мелкие шаги. Какжый шаг в идеале должен быть часа на 3-4 работы
    - **Никаких исследований в плане**: Не должно быть в плане пунктов типа "исследовать такую то проблему" или "решить как будем переносить модуль". Все что нужно уточнить или исследовать делаем до фиксации плана. В плане только указания к конкретным действиям. Если что то надо понять, придумать, уточнить, то делай это сначала  
